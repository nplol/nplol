...
(function() {
  $(function() {
    ...
    return $(document).on('ajax:beforeSend', function(event, xhr) {
...
(function() {
  $(function() {
    $('#new_comment').on('ajax:success', function(event, html) {
      return $('#comments').append(html);
    });
    return $('#new_comment').on('ajax:error', function(event, response) {
      return $(this).html(response.responseText);
    });
  });
